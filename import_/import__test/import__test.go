...
func TestImportImportBillsWithWireMock(
	...
	VerifyRequestCount(t, "POST", "/Import/billsForm/8cfec329267", nil, 1)
}
...
func TestImportImportCustomerWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/Import/customersForm/8cfec329267", nil, 1)
}
...
func TestImportImportVendorWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/Import/vendorsForm/8cfec329267", nil, 1)
}
