...
func (r *RawClient) ListDevices(
	...
	opts ...option.RequestOption,
) (*core.Response[*payabli.QueryDeviceResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*payabli.QueryDeviceResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
...
func (r *RawClient) ListDevicesOrg(
	ctx context.Context,
	// The numeric identifier for organization, assigned by Payabli.
	orgId int,
...
func (r *RawClient) ListPayoutSubscriptions(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/Query/payoutsubscriptions/%v",
		entry,
	)
	queryParams, err := internal.QueryValues(request)
	if err != nil {
	...
	return &core.Response[*payabli.QueryPayoutSubscriptionResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
